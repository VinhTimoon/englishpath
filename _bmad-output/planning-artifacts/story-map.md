...
`dev`; `EP3-ST001` through `EP3-ST005` are complete and merged. `EP3-ST006`
is the single next dependency-ready story in `stories/ready`. Later Phase 3–5 stories remain backlog
...
| `EP3-ST006` | Controlled media/transcript API                                        | `EP3-ST005` (ready)              |
