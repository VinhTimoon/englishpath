...
Execution queue: `EP3-ST001` is complete and merged to `dev`; `EP3-ST002` is now
`EP3-ST002` is complete and merged to `dev`; `EP3-ST003` is the single story in
supervised review. Later Phase 3–5 stories remain backlog until dependencies pass.
