...
Execution queue: `EP3-ST001`, `EP3-ST002`, and `EP3-ST003` are complete and
merged to `dev`; `EP3-ST004` is in supervised review after same-story recovery.
...
| `EP3-ST004` | Admin library inventory/review UI                                      | `EP3-ST003` (review)             |
