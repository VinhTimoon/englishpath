...
`EP1-ST036` is in progress for the reviewed quiz and daily-sentence seed baseline;
it preserves the existing five-card session and twenty governed sentence seeds while
adding explicit content invariants.
