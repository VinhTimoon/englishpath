...
`EP5-ST003` is done and merged into `dev`; `EP5-ST004` is the next dependency-ready
Phase 5 story. Later stories stay backlog until their direct predecessor passes.
