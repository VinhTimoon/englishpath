...
export type ShadowingAttemptRecord = {
  attemptKey: string;
  segmentIndex: number;
  positionSeconds: number;
  status: string;
...
export type LibraryLearningRepositoryPort = {
  ...
  findShadowingAttempt?(
    userId: string,
    contentVersionId: string,
  ): Promise<ShadowingAttemptRecord | null>;
  listShadowingAttempts?(
    userId: string,
    contentVersionId: string,
  ): Promise<ShadowingAttemptRecord[]>;
  upsertShadowingAttempt?(
    userId: string,
    contentVersionId: string,
    data: {
      segmentIndex: number;
