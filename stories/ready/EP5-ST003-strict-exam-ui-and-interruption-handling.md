...
```text
pnpm story:doctor -- stories/ready/EP5-ST003-strict-exam-ui-and-interruption-handling.md
pnpm planning:traceability
pnpm --filter web lint
pnpm --filter web typecheck
pnpm --filter web exec vitest run
pnpm e2e --grep "TOEIC timed test learner journey"
pnpm story:verify stories/ready/EP5-ST003-strict-exam-ui-and-interruption-handling.md
pnpm story:checks
git diff --check
```

If the repository has no frontend unit test script or the focused E2E command is
not supported, report the exact unavailable command and rely on the existing
project-wide gate; never claim an unavailable check passed.
